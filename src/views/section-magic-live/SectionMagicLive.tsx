...
// 定义一个名为 SectionMagicLive 的 React 函数组件，返回一个 React 元素
function SectionMagicLive(): React.ReactElement {
  ...
  useGSAP(() => {
    ...
    // 动画：title 元素透明度变为 1，持续 0.5 秒
    timeline.to('.section-magic-live .title', { opacity: 1, duration: 0.5 });

    // 动画：section-wrapper 元素垂直偏移 -5%，持续 1 秒
    timeline.to('.section-magic-live .section-wrapper', {
      yPercent: -5,
      duration: 1
    });
    // 动画：subtitle 元素从 y 偏移 60，透明度 0 到 y 偏移 0，透明度 1，持续 1 秒，与上一个动画同时开始
    timeline.fromTo(
